...
public class ProjectGenerator {
	...
	protected void pushToGit() throws IOException {
	    commands.add("git"); commands.add("init");
	 	buildProcess(commands, "../webapp");

		commands.clear();
		wait(2000);
		
		commands.add("git"); commands.add("add"); commands.add(".");
		buildProcess(commands, "../webapp");
		
		commands.clear();
		wait(2000);
		
		commands.add("git"); commands.add("commit"); commands.add("-m"); commands.add("\"First Push\""); 
		buildProcess(commands, "../webapp");
	}
